...
public class jtree extends javax.swing.JFrame {
    ...
    public jtree() {
        Cargardatasmodelojtree();
        initComponents();
    }
    private void Cargardatasmodelojtree()
    {
           DefaultMutableTreeNode colores = new DefaultMutableTreeNode("colores");
           DefaultMutableTreeNode colorojo = new DefaultMutableTreeNode("rojo");
           DefaultMutableTreeNode colorazul = new DefaultMutableTreeNode("azul");
           colores.add(colorojo);
           colores.add(colorazul);
              ...
              deportes.add(futbol);
              DefaultMutableTreeNode futbolsal = new DefaultMutableTreeNode("futbol sala");
              DefaultMutableTreeNode futbolcom = new DefaultMutableTreeNode("futbol completo");
              futbol.add(futbolsal);
              futbol.add(futbolcom);
    ...
    private void initComponents() {
        ...
        jtree.getSelectionModel().addTreeSelectionListener(oyentetree);
